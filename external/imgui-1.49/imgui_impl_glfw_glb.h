...
IMGUI_API void        ImGui_ImplGlfwGLB_NewFrame();

// Use if you want to reset your rendering device without losing ImGui state.
IMGUI_API void        ImGui_ImplGlfwGLB_InvalidateDeviceObjects();
IMGUI_API bool        ImGui_ImplGlfwGLB_CreateDeviceObjects();

// GLFW callbacks (installed by default if you enable 'install_callbacks' during initialization)
// Provided here if you want to chain callbacks.
// You can also handle inputs yourself and use those as a reference.
IMGUI_API void        ImGui_ImplGlfwGLB_MouseButtonCallback(GLFWwindow* window, int button, int action, int mods);
